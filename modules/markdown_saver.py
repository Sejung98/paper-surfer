...
class MarkdownSaver:
    ...
    def save_paper(self, paper_data: Dict) -> bool:
        ...
        try:
            ...
            # Generate filename (title + PMID)
            filename = f"{self.sanitize_filename(title)}_PMID_{pmid}"
